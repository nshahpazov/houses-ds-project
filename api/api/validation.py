"""
Validating the schema of the API restful operations
"""
import typing as t
...
class HouseDataRequestSchema(Schema):
    """Schema object encompassing the houses data object"""
